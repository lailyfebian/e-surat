...
/**
 * AppovalRulesSuratKeluar represents the model behind the search form of `app\models\ApprovalSuratKeluar`.
 */
class AppovalRulesSuratKeluar extends ApprovalSuratKeluar
{
    /**
     * {@inheritdoc}
     */
